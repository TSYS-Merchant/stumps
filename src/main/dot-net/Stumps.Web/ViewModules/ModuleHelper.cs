namespace Stumps.Web.ViewModules
{
    ...
    {
        /// <summary>
        ///     Returns a string value depending on the state of a <see cref="StumpsServerInstance"/>.
        /// </summary>
        ...
        /// <returns>A <see cref="String"/> representing the state of the server.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="serverInstance"/> is <c>null</c>.</exception>
